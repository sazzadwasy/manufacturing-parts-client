...
const Blogs = () => {
    return (
        <div className='px-12'>
            ...
            <p className='text-xl'>Ans : React only renders components when the state of a component changes. If we extract the part of the code in a local component, then only the component will be rendered and no unnecessary render will happen.
                ...
                With React-lazyload or React-lazy-load-image component images will only rendered exactly before when we are about to view to portion of the component that can improve react app performance</p>
            <br />
            <br />
            <p className='text-xl font-bold'>What are the different ways to manage a state in a React Application?</p>
            <p className='text-xl'>Ans : Initially we use useState and useReducer to manage local and global states
            ...
            <p className='text-xl'>Ans : JavaScript Objects have a property called [[prototype]]
            ...
            <br />
            <br />
            <p className='text-xl font-bold'>Why you do not set the state directly in React?</p>
            <p className='text-xl'>Ans : Firstly, We use state in a react application, so that we can rerender the DOM efficiently and effectively.
            ...
            <p className='text-xl'>Ans : Unit test is testing small parts/component of our application in isolation
